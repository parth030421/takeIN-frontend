...
export default class CheckBox extends Component {
    ...
    genCheckedImage() {
        ...
        if (this.props.isIndeterminate) {
            ...
            source = this.props.isChecked ? 'checkbox-marked' : 'checkbox-blank-outline';
            color = this.props.isChecked ? '#442B7E' : '#999999';
        }

        return (
            <Icon name={source} size={22} color={color}></Icon>
        );
    }
    ...
    render() {
        return (
            <TouchableHighlight
                style={[this.props.style, { borderRadius: 10, width: 25, height: 25 }]}
