...
export default class launchingSoon extends React.Component {
    state = {
        modalVisible: false,
        loading: true,
        savedAddressList: []
                    ...
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            ...
                            <Row style={{ paddingTop: 13, height: 43 }}>
                                ...
                                <Col sm={11} >
                                    <Pressable onPress={() => this.setAddModalVisible(!modalVisible)}>
                                        <AddAddress title={'Add new Address'}></AddAddress>
                                    </Pressable>
                                </Col>
                            </Row>
                        </View>
                        ...
                        this.props.pageName == 'Home' ?
                            (
                                <View style={CS.Col}>
                                    ...
                                    <Row Hidden={APIKit.savedAddressList == []}><Text style={[Config.style.font16, styles.selectedAddress, Config.style.FontMedium, Config.style.FW500]}>{APIKit.locationTitle}</Text></Row>
                                    {
