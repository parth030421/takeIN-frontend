...
import { Footer, Button, Wrapper, Header, Left, Row, Col, Container, Space, H3, OTPTextInput, SelectPhoneCode, P } from '../components/componentIndex';
        ...
        return (
            ...
            <Wrapper style={{ marginTop }} footer={footer}>
                ...
                <Container>
                    ...
                    <Row>
                        <Col sm={10} >
                            <Text style={[CS.font20, CS.FW500, { color: '#333333' }]}>Please enter your new mobile phone</Text>
                        </Col>
                    </Row>
                    <Row style={styles.inputContainer}>
                        <Col sm={4} style={[CS.Col, { alignItems: 'flex-end' }]}>
                            <SelectPhoneCode parentCallback={this.handleCallback}></SelectPhoneCode></Col>
                        <Col><TextInput placeholderTextColor={'#999999'}
                            ...
                            underlineColorAndroid={'transparent'}></TextInput></Col>
                    </Row>
                </Container>
